        ...
        */
        socket.on('auth success', function(obj) {
            ...
            var html = Mustache.render(template, {
                ...
                criminal_code: obj.details.criminal_code,
                no_of_crimes_committed :obj.details.no_of_crimes_committed,
                address :obj.details.address,
                recent_crime :obj.details.recent_crime,
                age :obj.details.age,
                gender :obj.details.gender,
